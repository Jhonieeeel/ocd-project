    ...
    <div class="-m-1.5 overflow-x-auto">
        <div class="inline-block min-w-full p-1.5 align-middle">
            <div class="overflow-hidden">
                <table
                    class="w-full table-fixed overflow-hidden rounded-lg border border-gray-200 text-justify dark:border-neutral-700"
                >
                    <thead class="truncate bg-orange-400">
                        <tr>
                            <th
                                scope="col"
                                class="truncate px-6 py-3 text-start text-xs font-medium uppercase dark:text-neutral-500"
                            >
                                Code Pap
                            </th>
                            <th
